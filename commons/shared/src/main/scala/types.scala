...
object types {
  ...
  given JsonDecoder      [Magic]           = JsonDecoder.string //JsonDecoder.string
  given JsonDecoder      [Pin]             = JsonDecoder.string //JsonDecoder.string
  given JsonDecoder      [Link]            = JsonDecoder.string //JsonDecoder.string
