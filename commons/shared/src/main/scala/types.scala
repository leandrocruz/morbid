...
object types {
  ...
  given JsonDecoder      [AccountName]       = JsonDecoder.string //safeLatinName(256)
  given JsonDecoder      [AccountIdentifier] = JsonDecoder.string
  given JsonDecoder      [ApplicationName]   = JsonDecoder.string //safeLatinName(256)
  given JsonDecoder      [GroupName]         = JsonDecoder.string //safeLatinName(64)
  given JsonDecoder      [RoleName]          = JsonDecoder.string //safeLatinName(32)
  given JsonDecoder      [PermissionName]    = JsonDecoder.string //safeLatinName(128)
  given JsonDecoder      [PlanName]          = JsonDecoder.string //safeLatinName(128)
  given JsonDecoder      [FeatureName]       = JsonDecoder.string //safeLatinName(128)
  given JsonDecoder      [ProviderName]      = JsonDecoder.string //safeLatinName(256)

  given JsonDecoder      [TenantCode]      = JsonDecoder.string //safeCode(64)
  given JsonDecoder      [AccountCode]     = JsonDecoder.string //safeCode(16)
  given JsonDecoder      [ApplicationCode] = JsonDecoder.string //safeCode(16)
  given JsonDecoder      [GroupCode]       = JsonDecoder.string //safeCode(16)
  given JsonDecoder      [UserCode]        = JsonDecoder.string //safeCode(128)
  given JsonDecoder      [RoleCode]        = JsonDecoder.string //safeCode(16)
  given JsonDecoder      [PermissionCode]  = JsonDecoder.string //safeCode(16)
  given JsonDecoder      [PlanCode]        = JsonDecoder.string //safeCode(32)
  given JsonDecoder      [FeatureCode]     = JsonDecoder.string //safeCode(32)
  given JsonDecoder      [ProviderCode]    = JsonDecoder.string //safeCode(128)

  given JsonDecoder      [Email]           = JsonDecoder.string //safeDecode(email, 256)
  given JsonDecoder      [Domain]          = JsonDecoder.string //safeDecode(domain, 256)
