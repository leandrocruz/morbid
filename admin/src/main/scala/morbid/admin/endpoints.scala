...
object Endpoints {
  ...
  def applicationCreate (req: CreateApplicationRequest) = FetchRequest("/application")  .post[CreateApplicationRequest, RawApplicationDetails]    (req)
  def applicationUpdate (req: UpdateApplicationRequest) = FetchRequest("/application")  .put[UpdateApplicationRequest, RawApplicationDetails]     (req)
