...
import com.google.firebase.auth.{ActionCodeSettings, FirebaseAuth, FirebaseToken, UserRecord}
import com.google.firebase.auth.UserRecord.{CreateRequest, UpdateRequest}
